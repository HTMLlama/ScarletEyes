...
class StoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pageOne = "I remember. It all came rushing back. The last thing I saw. Those red eyes. The purr of their voice slicing through the silence like the blade of a will sharpened katana through an enemy. I remember the spray of blood. The hot sticky wetness across my face.\n" +
        ...
        val pageFive = "\"Welcome to world of darkness. You will get used to the red eyes. The reason you feel dizzy right now is because your equilibrium is still adjusting.\\\" \\n\n" +
